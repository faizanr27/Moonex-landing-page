...
const ComparisonSection = () => {
  ...
  return (
    <div className="px-6 py-24 overflow-hidden max-w-7xl mx-auto mt-20 xl:mt-40">
      ...
      className="text-4xl text-white font-bold text-center sm:text-left mb-12">
      ...
      <motion.div
      initial={{opacity:0, y: 30}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{delay:0.6 ,duration:0.5}}
      className="sm:mx-auto bg-gray-800/30 backdrop-blur-xl rounded-xl p-4 sm:p-12 max-w-7xl ">
